...
public class StonePlowItem extends CountrycraftModElements.ModElement {
	@ObjectHolder("countrycraft:stone_plow")
	public static final Item block = null;
	public StonePlowItem(CountrycraftModElements instance) {
		super(instance, 7);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("stone_plow"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CountryCraftItemsItemGroup.tab).maxDamage(131));
		}
