...
public class GoldenPlowItem extends CountrycraftModElements.ModElement {
	@ObjectHolder("countrycraft:golden_plow")
	public static final Item block = null;
	public GoldenPlowItem(CountrycraftModElements instance) {
		super(instance, 4);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("golden_plow"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CountryCraftItemsItemGroup.tab).maxDamage(32));
		}
