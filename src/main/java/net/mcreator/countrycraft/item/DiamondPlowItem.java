...
package net.mcreator.countrycraft.item;
...
public class DiamondPlowItem extends CountrycraftModElements.ModElement {
	@ObjectHolder("countrycraft:diamond_plow")
	public static final Item block = null;
	public DiamondPlowItem(CountrycraftModElements instance) {
		super(instance, 10);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("diamond_plow"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CountryCraftItemsItemGroup.tab).maxDamage(1561));
		}
