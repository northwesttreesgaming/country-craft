...
public class IronPlowItem extends CountrycraftModElements.ModElement {
	@ObjectHolder("countrycraft:iron_plow")
	public static final Item block = null;
	public IronPlowItem(CountrycraftModElements instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("iron_plow"));
	}
	private static class ItemToolCustom extends Item {
		protected ItemToolCustom() {
			super(new Item.Properties().group(CountryCraftItemsItemGroup.tab).maxDamage(250));
		}
